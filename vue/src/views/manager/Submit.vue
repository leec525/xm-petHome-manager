<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入上报说明" style="width: 200px" v-model="description"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe>
        ...
        <el-table-column prop="description" label="上报说明" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="请上报真实有效的信息，谢谢配合！" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="description" label="上报说明">
