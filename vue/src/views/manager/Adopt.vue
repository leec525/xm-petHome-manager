<template>
  <div>
    <div class="search">
      <el-select v-model="animalId" placeholder="请选择宠物" style="width: 150px; margin-left: 5px" v-if="user.role === 'ADMIN'">
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="animalImg" label="宠物图片" show-overflow-tooltip>
        ...
        <el-table-column prop="animalName" label="宠物名字" show-overflow-tooltip></el-table-column>
